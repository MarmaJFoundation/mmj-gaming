...
Shader "Shadero Customs/AngelShader"
{
Properties
{
[PerRendererData] _MainTex("Sprite Texture", 2D) = "white" {}
PixelXYUV_SizeX_1("PixelXYUV_SizeX_1", Range(1, 128)) = 64
PixelXYUV_SizeY_1("PixelXYUV_SizeY_1", Range(1, 128)) = 64
_Generate_Fire_PosX_1("_Generate_Fire_PosX_1", Range(-1, 2)) = 0
_Generate_Fire_PosY_1("_Generate_Fire_PosY_1", Range(-1, 2)) = -0.082
_Generate_Fire_Precision_1("_Generate_Fire_Precision_1", Range(0, 1)) = 0.05
_Generate_Fire_Smooth_1("_Generate_Fire_Smooth_1", Range(0, 1)) = 0.918
...
float4 _Generate_Fire_1 = Generate_Fire(PixelXYUV_1,_Generate_Fire_PosX_1,_Generate_Fire_PosY_1,_Generate_Fire_Precision_1,_Generate_Fire_Smooth_1,_Generate_Fire_Speed_1,0);
